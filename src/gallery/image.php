...
<div id="gallery_wrapper">	
	...
	<script type="text/javascript">
		...
		var appFbUrl = 'https://apps.facebook.com/<?php echo $GLOBALS["appAlias"]?>/';
		...
		var fbShareUrl = 'https://www.facebook.com/sharer.php?u=';//'../php/facebook/shareplugin.php?imageParams=';
		...
		function showImage(currentImage){
			...
			?>
				...
				var deleteLink = '<span class="deleteLink" data-id="' + currentImageObj['id'] + '" style="color:red;cursor:pointer;margin-left:10px;">X Delete</span>';
